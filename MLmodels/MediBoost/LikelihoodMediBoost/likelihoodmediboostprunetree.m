function tree = likelihoodmediboostprunetree(tree,prevDec)
% LIKELIHOODMEDIBOOSTPRUNETREE - Returns a pruned version of the input tree based on
...
% 
% SEE ALSO
%   likelihoodmediboostchoosefeat, likelihoodmediboostdrawtree, likelihoodmediboosttrain, likelihoodmediboostvalue
    ...
    if tree.right.terminal == false
        ...
        if tree.right.terminal == false
            tree.right = likelihoodmediboostprunetree(tree.right,prevDecRight);
        end
    end
    if tree.left.terminal == false
        ...
        if tree.left.terminal == false
            tree.left = likelihoodmediboostprunetree(tree.left,prevDecLeft);
        end
    end
